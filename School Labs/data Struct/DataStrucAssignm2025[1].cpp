    ...
    do {
        ...
        switch (choice) {
            case 1:
                ...
                for (int i = 0; i < menuSize; ++i) {
                    ...
                    if (menuItemName == userInput) {
                        ...
                        addToCartChoice = customer.enter_number();

                        if (addToCartChoice == 1) {
                            MenuItem newItem = menu[i];
                            cout << "Enter quantity: ";
                            quantity = customer.enter_number();
            ...
            case 2:
                ...
                selectedId = customer.enter_number();
